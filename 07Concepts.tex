...
% =====================================================
\begin{frame}[fragile]{Principe 1~: L'Abstraction}
  ...
  \textbf{Dans le code~:}
  \begin{lstlisting}[language=Java,basicstyle=\ttfamily\footnotesize,frame=single,numbers=left]
...
% =====================================================
\begin{frame}[fragile]{Principe 2~: L'Encapsulation}
  ...
  \textbf{Pourquoi c'est important~?} Les données sont protégées, On contrôle comment les données sont modifiées.
